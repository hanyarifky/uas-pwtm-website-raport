    ...
    <div class="relative p-5 overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <form method="POST" action="/admin/mata-pelajaran">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    <label for="jumlah_jam" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah Jam (Menit)</label>
                    <input name="jumlah_jam" type="number" id="jumlah_jam" value="{{ old('jumlah_jam') }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                    @error('jumlah_jam') 
                                bg-red-50 border border-red-500 text-red-900 placeholder-red-700 text-sm rounded-lg focus:ring-red-500 dark:bg-gray-700 focus:border-red-500 block w-full p-2.5 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500
                    @enderror"
