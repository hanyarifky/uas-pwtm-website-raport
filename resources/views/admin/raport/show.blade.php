                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="text-center">
                            @if ($nilai->mata_pelajarans->nilai_kkm < $nilai->nilai_total)
                                <span class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-gray-700 dark:text-green-400 border border-green-400">Terpenuhi</span>
                            </span>
                            @else
                            <span class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-gray-700 dark:text-red-400 border border-red-400">Tidak Terpenuhi</span>
                            @endif
                           
                        </td>
                        <td class="px-6 py-4">
                            <a href="{{ route('raport.nilai', $nilai->id) }}" class="text-blue-600 hover:text-blue-800">Nilai</a>
                            {{-- <a href="{{ route('rapor.delete', $nilai->id) }}" class="text-red-600 hover:text-red-800 ml-2">Delete</a> --}}
                        </td>
                    </tr>
                @endforeach
            </tbody>
